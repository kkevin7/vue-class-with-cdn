...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-10-2019 a las 18:15:56
...
-- Base de datos: `tarea`
--
CREATE DATABASE IF NOT EXISTS `tarea` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tarea`;
...
--
ALTER TABLE `tipo`
  MODIFY `id_tipo_tarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
